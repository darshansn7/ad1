...
locals {
  ...
  vm1_virtual_machine_name         = "${local.base_name_prefix}vm1${local.base_name_suffix}"
  vm1_recovery_services_vault_name = "${local.base_name_prefix}rsv1${local.base_name_suffix}"
  vm1_vm_backup_policy_name        = "${local.base_name_prefix}bp1${local.base_name_suffix}"
  ...
  vm2_virtual_machine_name         = "${local.base_name_prefix}vm2${local.base_name_suffix}"
  vm2_recovery_services_vault_name = "${local.base_name_prefix}rsv2${local.base_name_suffix}"
  vm2_vm_backup_policy_name        = "${local.base_name_prefix}bp2${local.base_name_suffix}"
  ...
  vm3_virtual_machine_name         = "${local.base_name_prefix}vm3${local.base_name_suffix}"
  vm3_recovery_services_vault_name = "${local.base_name_prefix}rsv3${local.base_name_suffix}"
  vm3_vm_backup_policy_name        = "${local.base_name_prefix}bp3${local.base_name_suffix}"
  ...
  vm4_virtual_machine_name         = "${local.base_name_prefix}vm4${local.base_name_suffix}"
  vm4_recovery_services_vault_name = "${local.base_name_prefix}rsv4${local.base_name_suffix}"
  vm4_vm_backup_policy_name        = "${local.base_name_prefix}bp4${local.base_name_suffix}"
